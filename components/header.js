...
export default function Header() {
  ...
  return (
    <>
      {useBreakpointValue({
        base: <HeaderMobile router={router} bg={bg} borderColor={borderColor} boxShadow={boxShadow} boxShadowBottom={boxShadowBottom} navItems={navItems} />,
        md: <HeaderDesktop router={router} bg={bg} borderColor={borderColor} boxShadow={boxShadow} boxShadowBottom={boxShadowBottom} navItems={navItems} />,
      })}
    </>
  );
}

function HeaderDesktop({ navItems, router, bg, borderColor, boxShadow, boxShadowBottom }) {
                    ...
                    <Button
                      ...
                      leftIcon={
                        <Icon
                          ...
                          color={
                            isActive
                              ? useColorModeValue("brand.primary.400", "white")
                              : useColorModeValue(
                                  "brand.primary.400",
                                  "brand.primary.100"
                                )
...
function HeaderMobile({ navItems, router, bg, borderColor, boxShadow, boxShadowBottom }) {
  const { colorMode, toggleColorMode } = useColorMode();
  return (
    <Grid
      templateColumns="100%"
